...
func (m Model) Convert() {
	...
	if m.IsGPU {
		cmd = exec.Command("ffmpeg", "-y", "-i",
			...
			"-filter:v:0", "scale=w=640:h=360", "-maxrate:v:0", "1600k", "-b:a:0", "64k",
			"-filter:v:1", "scale=w=854:h=480", "-maxrate:v:1", "4000k", "-b:a:1", "128k",
			"-filter:v:2", "scale=w=1280:h=720", "-maxrate:v:2", "8000k", "-b:a:2", "128k",
			"-filter:v:3", "scale=w=1920:h=1080", "-maxrate:v:3", "16000k", "-b:a:3", "192k",
			"-filter:v:4", "scale=w=2560:h=1440", "-maxrate:v:4", "20000k", "-b:a:4", "192k",
			"-filter:v:5", "scale=w=3840:h=2160", "-maxrate:v:5", "35000k", "-b:a:5", "192k",
